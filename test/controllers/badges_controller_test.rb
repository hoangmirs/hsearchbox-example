...
class BadgesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create badge" do
    assert_difference('Badge.count') do
      post badges_url, params: { badge: { image: @badge.image, name: @badge.name, user_id: @badge.user_id } }
    end
  ...
  test "should update badge" do
    patch badge_url(@badge), params: { badge: { image: @badge.image, name: @badge.name, user_id: @badge.user_id } }
